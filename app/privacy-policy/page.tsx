...
async function getPrivacyPolicy(): Promise<string> {
    try {
        const res = await fetch(
            "https://api.creepy-shorts.com/api/v1/settings?key=privacyPolicy",
            { cache: "no-store" }
        );
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white relative overflow-hidden">
            ...
            <main className="max-w-4xl mx-auto px-6 pb-16">
                <div
                    className="prose-policy rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-sm p-8"
